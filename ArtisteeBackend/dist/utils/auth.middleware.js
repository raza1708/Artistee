...
var validateAuthInput = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        ...
        if (!!!userName || !!!password) {
            (0, exports.sendResponseError)(400, { message: 'Invalid Input !!', isOk: false }, res);
            return [2 /*return*/];
        }
        next();
        return [2 /*return*/];
...
var protect = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        _a = req.body, userName = _a.userName, password = _a.password;
        try {
            if ((0, utility_function_1.isAuthenticated)(userName, password)) {
                next();
            }
            else {
                (0, exports.sendResponseError)(400, { message: "you are not authorizeed", isOk: false }, res);
            }
        }
        catch (err) {
            console.log('Error ', err);
            (0, exports.sendResponseError)(400, "Error ".concat(err), res);
        }
        return [2 /*return*/];
    });
}); };
